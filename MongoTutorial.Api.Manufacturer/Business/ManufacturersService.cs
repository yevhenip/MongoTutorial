...
namespace MongoTutorial.Api.Manufacturer.Business
{
    public class ManufacturerService : ServiceBase<Domain.Manufacturer>, IManufacturerService
    {
        ...
        public async Task<Result<ManufacturerDto>> GetAsync(string id)
        {
            ...
            if (cache.TryGetValue<Domain.Manufacturer>(out var cachedManufacturer))
            {
            ...
            manufacturerInDb = await FileExtensions.ReadFromFileAsync<Domain.Manufacturer>(_path, cacheKey + ".json");
        ...
        public async Task<Result<ManufacturerDto>> CreateAsync(ManufacturerModelDto manufacturer)
        {
            ...
            var manufacturerToDb = Mapper.Map<Domain.Manufacturer>(manufacturerDto);
        ...
        private async Task UpdateManufacturesInProduct(string id, Domain.Manufacturer manufacturer = null)
        {
